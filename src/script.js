...
const sounds = [
  ...
  new Audio('https://res.cloudinary.com/dzsnl7ocm/video/upload/v1562350828/Game_start.mp3'),
  new Audio('https://res.cloudinary.com/dzsnl7ocm/video/upload/v1562354481/start_beep.mp3'),
  new Audio('https://res.cloudinary.com/dzsnl7ocm/video/upload/v1562085132/Computer_Error-SoundBible.com-1655839472.wav'),
  new Audio('https://res.cloudinary.com/dzsnl7ocm/video/upload/v1562350828/Game_Win.mp3')
];
const Rounds = 20;
